...
class Logined extends React.Component {
    ...
    componentDidMount() {
        this.getSystemMsg(this.state.token)
    }
    getSystemMsg(token){
        var that = this;
        var params = JSON.stringify({
            query:'{messages(token:"'+ token +'"){uid,url,message,createdDate}}'
        })
            ...
            <div>
                <div className="login-ed">
                    ...
                    <div className="avatar">
                        <img src={this.props.user.avatar||defImg} alt=""/>
                    </div>
                    <div className="name">{this.props.user.name}</div>
                    <div className="myMoney">
                        <div className="gold">
                            <div className="icon"></div>
                            <div className="count">{this.props.account.gold}</div>
                            <a href="exchangeGold.html"><div className="btn">兑换</div></a>
                        </div>
                        <div className="zuanshi">
                            <div className="icon"></div>
                            <div className="count">{this.props.account.diamonds}</div>
                            <a href="recharge.html"><div className="btn">购买</div></a>
                        </div>
                        <div className="jifen">
                            <div className="icon"></div>
                            <div className="count">{this.props.account.credit}</div>
